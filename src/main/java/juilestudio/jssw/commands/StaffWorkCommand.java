...
import juilestudio.jssw.utils.WorkUtils;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args.length > 0) {
            ...
            if (args[0].equalsIgnoreCase("on")) {
                ...
                if (!player.hasPermission("jsstaffwork.on")) {
                ...
                if (!player.hasPermission("jsstaffwork.off")) {
                ...
                if (args.length == 1) {
                    ...
                    if (!player.hasPermission("jsstaffwork.stats.me")) {
                        Utils.sendMessage(player, Utils.getString("messages.no-permission"));
                        return true;
                    }
                    ...
                    if (!player.hasPermission("jsstaffwork.stats.player")) {
                        Utils.sendMessage(player, Utils.getString("messages.no-permission"));
                        return true;
                    }
                ...
                if (playerName.equalsIgnoreCase("all")) {
                    ...
                    if (player.hasPermission("jsstaffwork.stats.all")) {
